...
#Add sources cc,c
EMBY_ADD_SOURCES(${EMBY_X86_PLATFORM} EMBY_PLAT_SOURCES)
...
EMBY_CREATE_NAMED_LIB(emby_core ${EMBY_X86_PLATFORM} ${EMBY_FOLDER}/core EMBY_SOURCES)

# Crea la libreria specifica per la piattaforma (es: emby_platform_X86_Unix) e alias emby_platform
EMBY_CREATE_NAMED_LIB(emby_platform ${EMBY_X86_PLATFORM} ${EMBY_X86_PLATFORM} EMBY_PLAT_SOURCES)
...
EMBY_ADD_TESTS(${EMBY_X86_PLATFORM})
