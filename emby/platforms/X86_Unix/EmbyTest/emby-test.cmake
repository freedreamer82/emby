...
# Attempt to find the top-level emby core cmake file (emby-core.cmake) in parent tree
set(EMBY_CORE_CMAKE "${CMAKE_CURRENT_SOURCE_DIR}/../../../../emby-core.cmake")

include( ${EMBY_CORE_CMAKE})
include( "${CMAKE_CURRENT_SOURCE_DIR}/../../emby-platform.cmake")

add_compile_options("${COMPILE_OPTS}")
add_link_options("${COMPILE_OPTS}" -Wl,--gc-sections -ffunction-sections)
